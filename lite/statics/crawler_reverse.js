...
document = {
    ...
    length: 0
    // cookie:"douyin.com; passport_csrf_token_default=7d6459f1bbf9bcca12efe7f1d6c06e4a; passport_csrf_token=7d6459f1bbf9bcca12efe7f1d6c06e4a; s_v_web_id=verify_4f456328a375ff70378cd06dc09891b1; MONITOR_WEB_ID=4af9a17f-afac-4f94-b85b-2ddf7ab17069"
};
...
CanvasRenderingContext2D = {
    canvas: {
        autocapitalize: "",
        autofocus: false,
        baseURI: "https://www.douyin.com/search/%E9%99%88%E8%B5%AB?source=search_history&aid=8fae9d42-6fd5-4d46-a9cc-4bbad683ed4f&enter_from=main_page",
        childElementCount: 0
    },
    direction: "ltr",
    fillStyle: "#000000",
...
location = {
    ...
    origin: "https://www.douyin.com",
    pathname: "/user/MS4wLjABAAAAAEtO1dCIZvj4VWbLU4Xce7DgVgsKNMNu88eNR2c2LtY",
    port: "",
    protocol: "https:",
    search: "?extra_params=%7B%22search_id%22%3A%2220210707105401010212154075531EFACF%22%2C%22search_result_id%22%3A%2284990209480%22%2C%22search_keyword%22%3A%22%E9%99%88%E8%B5%AB%22%2C%22search_type%22%3A%22video%22%7D&enter_method=search_result&enter_from=search_result",
                        ...
                        if ((A = x) > 14)
                            z = s(b, O),
                                (U = function e() {
                                        ...
                                        if (typeof e.z === "object") {
                                            if (Boolean(e.z[0].BytedAcrawler)) {
                                                e.z[95] = [
                                                    {
                                                        "x": 141,
                                                        "y": 305,
    ...
    function K(b, e, f, a, d, c, n, i) {
        if (typeof a === "object") {
            if (typeof a[0] == "object") {
                if (a[0].directSign === true) {
                    a[0].directSign = false
                }
                if (a[0].dom === true) {
                    a[0].dom = false
                }
...
function sign_post(url, body) {
    body = JSON.parse(body)
    return window.byted_acrawler.sign({url: url, body: body})
}

function test() {
    url = "https://www.douyin.com/aweme/v1/web/search/item/?device_platform=webapp&aid=6383&channel=channel_pc_web&search_channel=aweme_video_web&sort_type=0&publish_time=0&keyword=1949&search_source=normal_search&query_correct_type=1&is_filter_search=0&offset=0&count=24&version_code=160100&version_name=16.1.0&cookie_enabled=true&screen_width=1536&screen_height=864&browser_language=zh-CN&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F91.0.4472.101+Safari%2F537.36&browser_online=true"

    console.log(window.byted_acrawler.sign({url: url}))
}

function test_post() {
    url = 'https://www.douyin.com/aweme/v1/web/commit/item/digg/?device_platform=webapp&aid=6383&channel=channel_pc_web&version_code=160100&version_name=16.1.0&cookie_enabled=true&screen_width=1536&screen_height=864&browser_language=zh-CN&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F91.0.4472.101+Safari%2F537.36&browser_online=true'
    body = {
        "aweme_id": "6984008368784477454",
        "type": "1"
    }
    console.log(window.byted_acrawler.sign({url: url, body:body}))
